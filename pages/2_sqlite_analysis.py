...
st.markdown("<h1 style='color: yellow;'>⚽ Estadísticas de Jugadores</h1>", unsafe_allow_html=True)
# Conexión a la base de datos
conn = sqlite3.connect('data/chile.db')

# Estadísticas de Jugadores
# st.header("Equipo")
st.markdown("<h2 style='color: yellow;'>Equipo</h2>", unsafe_allow_html=True)
# Seleccionar un Club
...
st.markdown("<h2 style='color: yellow;'>Edad</h2>", unsafe_allow_html=True)
...
cols5[0].markdown("<h2 style='color: yellow;'>Jugadores</h2>", unsafe_allow_html=True)
cols5[0].dataframe(df_team5, hide_index=True, )

# cols5[1].header("Gráfico de Edades")
cols5[1].markdown("<h2 style='color: yellow;'>Gráfico de Edades</h2>", unsafe_allow_html=True)
...
cols6 = st.columns(2)
cols6[0].markdown("<h2 style='color: yellow;'>Gráfico de Puestos</h2>", unsafe_allow_html=True)
...
cols6[1].markdown("<h2 style='color: yellow;'>Gráfico de Nacionalidades</h2>", unsafe_allow_html=True)
...
st.markdown("<h2 style='color: yellow;'>Jugador</h2>", unsafe_allow_html=True)
...
cols8[0].markdown("<h2 style='color: yellow;'>Gráfico de Métricas</h2>", unsafe_allow_html=True)
...
cols8[1].markdown("<h2 style='color: yellow;'>Gráfico de MParticipación</h2>", unsafe_allow_html=True)
